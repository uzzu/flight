/**
 * @fileOverview  This file has DebugBuildTask class contained in a app/tasks. module.
 */
...
(function(undefined) {
  var as3ConfigConst = 'CONFIG::DEBUG="true";CONFIG::DEBUG4FLASH="false";';

  var DebugBuildTask = (function(super) {
    __inherit(DebugBuildTask, super);

    /**
     * Create a new DebugBuildTask object.
     * @memberOf  module:app/tasks
     * @class     DebugBuildTask
     * @extends   module:app/tasks.BuildTask
     * @param     {module:app.Context}  context - Application context.
     * @param     {Object}              options - Task options.
     */
    function DebugBuildTask(context, options) {
      super.call(this, context, options);
    }

    /**
     * @memberOf  module:app/tasks.DebugBuildTask.prototype
     * @name      _process
     * @function
     * @protected
     * @throws    {Error} When target file does not exist or target file is invalid format.
     */
    DebugBuildTask.prototype._process = function() {
    ...
    return DebugBuildTask;
  })(BuildTask);
  module.exports = DebugBuildTask;
})();
